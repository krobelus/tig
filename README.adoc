...
image:https://github.com/jonas/tig/workflows/Windows/badge.svg[Windows CI,link=https://github.com/jonas/tig/actions?query=workflow%3A.github%2Fworkflows%2Fwindows.yml]
